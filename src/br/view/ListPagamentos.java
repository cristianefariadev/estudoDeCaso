...
public class ListPagamentos extends JInternalFrame {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListPagamentos frame = new ListPagamentos();
	...
	public ListPagamentos() {
		...
		panelPesquisarCliente.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Pesquisar Pagamentos", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
