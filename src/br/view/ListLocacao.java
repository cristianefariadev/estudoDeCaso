...
public class ListLocacao extends JInternalFrame {
	...
	public ListLocacao() {
		...
		panelPesquisarCliente.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Pesquisar Locacao", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
